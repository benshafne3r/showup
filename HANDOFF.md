...
## Next steps
1. Finish the Vercel deploy (dashboard import + env vars) — the only thing left to go live.
2. Optional: add a Bandsintown/Ticketmaster key for live tour-date imports.
